...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { description: @opportunity.description, name: @opportunity.name, rfp_url: @opportunity.rfp_url, user_id: @opportunity.user_id }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { description: @opportunity.description, name: @opportunity.name, rfp_url: @opportunity.rfp_url, user_id: @opportunity.user_id }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
